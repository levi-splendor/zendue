            ...
            <div>
              ...
              <div className="flex gap-2 mb-5 p-1 bg-white/5 rounded-xl">
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${mode === "password" ? "bg-indigo-600 text-white shadow-lg" : "text-zinc-400 hover:text-white"}`}
                >
                  Password
                </button>
                <button
                  onClick={() => setMode("magic")}
                  className={`flex-1 py-2 rounded-lg text-sm font-medium transition-all ${mode === "magic" ? "bg-indigo-600 text-white shadow-lg" : "text-zinc-400 hover:text-white"}`}
                >
                  ✨ Magic Link
                </button>
              </div>
              ...
              <button
                onClick={
                  mode === "password" ? handleEmailLogin : handleMagicLink
                }
                disabled={loading}
